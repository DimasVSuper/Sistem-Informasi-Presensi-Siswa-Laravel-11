...
| :--- | :--- | :--- | :--- | :--- | :--- |
| TCL-001 | Berada di halaman login. | 1. Masukkan email & password valid.<br>2. Klik tombol Login. | Email: admin@gmail.com<br>Pass: password | Redirect ke dashboard, muncul pesan sukses. | Passed |
| TCL-002 | Berada di halaman login. | 1. Masukkan email valid.<br>2. Masukkan password salah.<br>3. Klik tombol Login. | Email: admin@gmail.com<br>Pass: salah123 | Muncul pesan error "Kredensial tidak cocok". | Passed |
