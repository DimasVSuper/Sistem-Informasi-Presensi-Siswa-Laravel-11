...
## 1. Design System
- **Tailwind CSS**: Dikonfigurasi melalui Vite untuk dikompilasi menjadi satu file CSS statis yang ringan.
...
- **Feather Icons**: Library ikon vektor ringan yang dirender di sisi klien.
