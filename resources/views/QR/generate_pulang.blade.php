...
@section('title', 'Daftar QR Code Pulang Siswa')
...
<div class="print-area">
    <div class="text-center mb-8 no-print">
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Katalog QR Pulang Siswa</h1>
        <p class="text-gray-500 mt-2">Daftar kartu digital untuk scan presensi pulang</p>
    </div>
    ...
    <div class="qr-grid">
        ...
        <div class="qr-card">
            ...
            <span class="text-xs text-gray-400 font-medium mb-2 uppercase tracking-wide">QR Pulang</span>
